...
import { Tab, Tabs, ThemeProvider, createTheme, Dialog, DialogTitle, DialogContent, DialogActions, Button, Box, TextField } from "@mui/material";
...
export default function App() {
  ...
  useEffect(() => {
    const event = sdk.backend.onEvent("scans:error", (scanID: number, message: string) => {
