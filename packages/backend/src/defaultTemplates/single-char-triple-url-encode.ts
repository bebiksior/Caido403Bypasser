...
export const singleCharTripleUrlEncodeTemplate: Template = {
  id: "single-char-triple-url-encode",
  description:
    "Replaces character (1 at time) of the path with its triple encoded ASCII URL encode representation.",
  enabled: true,
  modificationScript: `
